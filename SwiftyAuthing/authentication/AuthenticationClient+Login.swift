...
extension AuthenticationClient
{
    ...
    /// 使用子账户登录
    ///
    public func loginBySubAccount(username: String,
                                  password: String,
                                  captchaCode: String? = nil,
                                  clientIp: String? = nil,
                                  completion: @escaping ((Result<GraphQLResult<LoginBySubAccountMutation.Data>, Error>) -> Void)) {
    ...
    ///
    public func loginByEmail(email: String,
                             password: String,
                             ...
                             params: String? = nil,
                             context: String? = nil,
                             completion: @escaping ((Result<GraphQLResult<LoginByEmailMutation.Data>, Error>) -> Void)) {
    ...
    /// 使用用户名登录
    ///
    public func loginByUsername(username: String,
                                password: String,
                                autoRegister: Bool? = nil,
                                captchaCode: String? = nil,
                                clientIp: String? = nil,
                                params: String? = nil,
                                context: String? = nil,
                                completion: @escaping ((Result<GraphQLResult<LoginByUsernameMutation.Data>, Error>) -> Void)) {
    ...
    /// 使用手机号验证码登录。
    ///
    public func loginByPhoneCode(phone: String,
                                 code: String,
                                 autoRegister: Bool? = nil,
                                 clientIp: String? = nil,
                                 params: String? = nil,
                                 context: String? = nil,
                                 completion: @escaping ((Result<GraphQLResult<LoginByPhoneCodeMutation.Data>, Error>) -> Void)) {
    ...
    /// 使用手机号密码登录
    ///
    public func loginByPhonePassword(phone: String,
                                     password: String,
                                     captchaCode: String? = nil,
                                     autoRegister: Bool? = nil,
                                     clientIp: String? = nil,
                                     params: String? = nil,
                                     context: String? = nil,
                                     completion: @escaping ((Result<GraphQLResult<LoginByPhonePasswordMutation.Data>, Error>) -> Void)) {
