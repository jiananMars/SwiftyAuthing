...
public class Config {
    ...
    /// Social link Host.
    ///
    public static let socialunlink = domain + "/api/v2/users/unlink"
    
    /// Get Security Level.
    ///
    public static let getSecurityLevel = domain + "/api/v2/users/me/security-level"
    
    /// listApplications
    ///
    public static let listApplicationsLink = domain + "/api/v2/users/me/applications/allowed"
    ...
    /// User App Id Key.
    ///
    public static var keyAppId = "appId"
    
    public static var keyHeaders: HTTPHeaders = HTTPHeaders()
    
    /// AccessToken Key.
    ///
    public static var keyAccessToken = "token"
